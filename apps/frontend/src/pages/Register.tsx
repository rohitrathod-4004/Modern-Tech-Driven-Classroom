    ...
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", background: "var(--bg-primary)" }}>
      <div style={{ 
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          <div>
            <label style={{ display: "block", color: "#cbd5e1", marginBottom: "0.5rem", fontSize: "0.9rem", fontWeight: 600 }}>Name</label>
            <input 
              type="text" 
              value={name} 
          ...
          <div>
            <label style={{ display: "block", color: "#cbd5e1", marginBottom: "0.5rem", fontSize: "0.9rem", fontWeight: 600 }}>I am a...</label>
            <select 
              value={role} 
            ...
            >
              ...
              <option value="faculty" style={{ background: "#0b0f19" }}>Faculty</option>
            </select>
          </div>
        ...
        <p style={{ color: "#94a3b8", textAlign: "center", marginTop: "1.75rem", fontSize: "0.9rem" }}>
          Already have an account? <Link to="/login" style={{ color: "var(--color-secondary)", fontWeight: 600, textDecoration: "none" }}>Login</Link>
        </p>
      </div>
    </div>
  );
